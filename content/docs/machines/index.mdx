...
See the [Security & trust model](/machines/security) page for a full account of what the control plane is and is not allowed to ask the daemon to do.

## In this section

- [Install](/machines/install) — install `mantlerd` on Linux or macOS
- [Configuration](/machines/configuration) — config file, CLI config commands, trust mode
- [CLI reference](/machines/cli) — all `mantler` subcommands
- [Security & trust model](/machines/security) — command allowlists, audit log, release verification
