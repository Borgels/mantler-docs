...
4. If a **Portal** layer is included, the endpoint becomes active.
...
When the Portal layer is active and the model is loaded, the mantle's model ID becomes available in `/v1/models` and accepts chat completions requests.
