...
The audit log records every server-originated command with its type, outcome, and any denial reason. See [Security & trust model](/docs/machines/security#audit-log) for details.
...
See [Configuration](/docs/machines/configuration) for all configurable fields.
