...
- **New to Mantler?** Start with [Getting started](/docs/getting-started).
- **Setting up a machine?** See [Installing mantlerd](/docs/machines/install).
- **Using the API?** See [Authentication](/docs/api/authentication) and [Endpoints](/docs/api/endpoints).
- **Security questions?** See the [Security overview](/docs/security).
