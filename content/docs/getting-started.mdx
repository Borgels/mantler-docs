...
- [Machine configuration](/docs/machines/configuration) — tune intervals, trust mode, allowed commands
- [CLI reference](/docs/machines/cli) — all `mantler` subcommands
- [API reference](/docs/api/endpoints) — full request/response spec
