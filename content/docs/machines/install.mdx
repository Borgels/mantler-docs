...
The update path verifies the SHA-256 checksum of the downloaded binary before replacing the running one. See [Release verification](/docs/machines/security#release-verification) for details.
