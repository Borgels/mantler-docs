...
1. Pick a **Machine** from from your registered machines.
2. Pick a **Runtime**. The palette filters to runtimes known to work on the selected machine.
3. Pick a **Model**. The palette filters to models compatible with the selected runtime and machine.
4. Optionally add **Harness**, **Orchestrator**, and **Endpoint** layers.
