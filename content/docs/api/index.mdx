...
- [Authentication](/docs/api/authentication) — API key format, scopes, org binding
- [Endpoints](/docs/api/endpoints) — full request/response spec for each endpoint
- [Usage & limits](/docs/api/usage-and-limits) — usage logging and rate limits
